...
import { UserCreateNestedOneWithoutConfirmedContributionsInput } from '../user/user-create-nested-one-without-confirmed-contributions.input';

@InputType()
export class FundContributionCreateWithoutTransactionsInput {
    ...
    @Field(() => UserCreateNestedOneWithoutConfirmedContributionsInput, {nullable:true})
    confirmedByUser?: UserCreateNestedOneWithoutConfirmedContributionsInput;
}
