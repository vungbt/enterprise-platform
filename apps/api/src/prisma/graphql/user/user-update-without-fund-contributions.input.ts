...
import { FundContributionUpdateManyWithoutConfirmedByUserNestedInput } from '../fund-contribution/fund-contribution-update-many-without-confirmed-by-user-nested.input';
...
@InputType()
export class UserUpdateWithoutFundContributionsInput {
    ...
    @Field(() => FundContributionUpdateManyWithoutConfirmedByUserNestedInput, {nullable:true})
    confirmedContributions?: FundContributionUpdateManyWithoutConfirmedByUserNestedInput;
