...
import { FundContributionUncheckedUpdateManyWithoutConfirmedByUserNestedInput } from '../fund-contribution/fund-contribution-unchecked-update-many-without-confirmed-by-user-nested.input';
...
@InputType()
export class UserUncheckedUpdateWithoutFundContributionsInput {
    ...
    @Field(() => FundContributionUncheckedUpdateManyWithoutConfirmedByUserNestedInput, {nullable:true})
    confirmedContributions?: FundContributionUncheckedUpdateManyWithoutConfirmedByUserNestedInput;
