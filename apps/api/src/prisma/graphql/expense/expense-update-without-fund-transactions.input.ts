...
import { ClubUpdateOneWithoutExpensesNestedInput } from '../club/club-update-one-without-expenses-nested.input';
...
@InputType()
export class ExpenseUpdateWithoutFundTransactionsInput {
    ...
    @Field(() => ClubUpdateOneWithoutExpensesNestedInput, {nullable:true})
    club?: ClubUpdateOneWithoutExpensesNestedInput;
