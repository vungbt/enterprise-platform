...
import { NestedEnumExpenseStatusWithAggregatesFilter } from './nested-enum-expense-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumExpenseStatusFilter } from './nested-enum-expense-status-filter.input';

@InputType()
export class EnumExpenseStatusWithAggregatesFilter {
