...
import { EmployeeUpdateManyWithoutManagerNestedInput } from './employee-update-many-without-manager-nested.input';
import { UserUpdateOneWithoutEmployeesNestedInput } from '../user/user-update-one-without-employees-nested.input';

@InputType()
export class EmployeeUpdateWithoutManagerInput {
    ...
    @Field(() => EmployeeUpdateManyWithoutManagerNestedInput, {nullable:true})
